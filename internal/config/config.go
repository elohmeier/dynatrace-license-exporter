...
func ReservedLabelNames() []string {
	return []string{
		...
		"auto_injection", "environment", "environment_id", "has_containers", "host", "host_category", "host_group", "host_id", "host_kubernetes_cluster",
		"host_kubernetes_cluster_entity_id", "host_kubernetes_distribution", "key", "kind", "location",
		"host_unit_band", "management_zone", "monitor_type", "monitoring_mode", "network_zone", "paas", "pool", "premium_log_analytics", "source", "test_id", "value",
	}
}
